...
const faqItems = [
  ...
  },
  {
    ...
    a: "Ogni Sprint prevede un deliverable specifico — un playbook personalizzato, una strategia di mercato, un sistema organizzativo o una sessione IA su misura. Non consulenza generica: qualcosa di concreto che puoi usare subito.",
  },
  {
  ...
  },
  {
    ...
    a: "No — lavoro in italiano, francese e inglese. Se hai un business in Italia ma vuoi espanderti in Francia o nel mondo anglofono, sono la persona giusta.",
  },
  {
    q: "Cosa ti rende diversa da un consulente tradizionale?",
    a: "I consulenti tradizionali fanno analisi lunghe e consegnano report. Io lavoro con te, non per te. L'obiettivo non è che tu abbia bisogno di me per sempre — è che alla fine dello Sprint tu sappia fare da solo/a quello che abbiamo costruito insieme.",
  },
  {
    q: "Come funziona il pagamento?",
    a: "Il pagamento avviene prima dell'inizio dello Sprint. Accetto bonifico bancario. Se hai domande sul pricing o vuoi discutere le opzioni, scrivimi — troviamo la soluzione giusta.",
  },
  {
    q: "Ho bisogno di esperienza con l'IA per partecipare al sprint AI? No Panico!?",
    a: "Assolutamente no — è pensato proprio per chi parte da zero. Prima capiamo insieme cosa stai cercando di fare, poi esploriamo gli strumenti più utili per il tuo business specifico. Niente teoria astratta, solo pratica.",
  },
  {
    q: "Il check-in gratuito dopo 30 giorni è incluso in tutti gli Sprint?",
    a: "Sì — ogni Sprint include un check-in gratuito dopo 30 giorni (o 2-3 mesi per Ciao France!). Perché il mio lavoro non finisce il giorno della consegna — voglio sapere come stai andando. 🤍",
  },
];
