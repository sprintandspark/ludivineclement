...
const QuizSection = () => {
  ...
  return (
  <section id="quiz" className="py-14 md:py-20 px-6" style={{ backgroundColor: '#4F46E5' }}>
      ...
      <div className="mx-auto max-w-3xl pb-10">
        <iframe
          data-tally-src="https://tally.so/embed/kd8GyR?alignLeft=1&transparentBackground=0&dynamicHeight=1"
          loading="lazy"
          width="100%"
          frameBorder="0"
          marginHeight={0}
